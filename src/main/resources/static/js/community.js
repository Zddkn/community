        ...
        type: "POST", url: "/comment", contentType: 'application/json', data: JSON.stringify({
            ...
            if (response.code == 200) {
                ...
                if (response.code == 2003) {
                    ...
                    if (isAccepted) {
                        window.open("https://github.com/login/oauth/authorize?client_id=b011fd89e4be9bd3427c&redirect_uri=http://localhost:8887/callback&scope=user&state=1")
            ...
            $.getJSON("/comment/" + id, function (data) {
                $.each(data.data.reverse(), function (index, comment) {
                    ...
                    var mediaLeftElement = $("<div/>", {
                        ...
                        "class": "media-object small-picture img-rounded", "src": comment.user.avatarUrl
                    }));

                    var mediaBodyElement = $("<div/>", {
                        "class": "media-body"
                    }).append($("<h4/>", {
                        "class": "media-heading", "html": comment.user.name
                    })).append($("<div/>", {
